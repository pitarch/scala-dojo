...
class BerlinClockTest extends FlatSpec {

  "Yellow lamp" should "blinks on/off every two seconds" in {

    BerlinClock.seconds(0) shouldBe "Y"

    BerlinClock.seconds(1) shouldBe "O"

    BerlinClock.seconds(2) shouldBe "Y"

    BerlinClock.seconds(59) shouldBe "O"
  }
